  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={clsx(
          '[&_.recharts-cartesian-axis-tick_text]:text-[var(--color-muted-foreground)]',
          "[&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-[var(--color-border)]/50",
          ...
          '[&_.recharts-radial-bar-background-sector]:text-[var(--color-muted)]',
          '[&_.recharts-rectangle.recharts-tooltip-cursor]:text-[var(--color-muted)]',
